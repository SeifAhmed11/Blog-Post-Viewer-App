        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-4 text-gray-400">
              Your one-stop platform for discovering and booking amazing events in your area.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Conferences</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Exhibitions</a></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-center">
                ...
                <span className="text-gray-300">123 Event St, City, Country</span>
              </li>
              <li className="flex items-center">
